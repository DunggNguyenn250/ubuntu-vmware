            ...
            <div class="form-row">
                <div class="form-group required">
                    ...
                    <input 
                        ...
                        id="mahopdong" 
                        name="mahopdong" 
                        value="<?= htmlspecialchars($hopdong['mahopdong'] ?? '') ?>"
                        readonly
                    >
                </div>
                ...
                <div class="form-group required">
                    ...
                    <input 
                        ...
                        id="masv" 
                        name="masv" 
                        value="<?= htmlspecialchars($hopdong['masv'] ?? '') ?>"
                        readonly
                    >
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group required">
                    ...
                    <input 
                        ...
                        id="maphong" 
                        name="maphong" 
                        value="<?= htmlspecialchars($hopdong['maphong'] ?? '') ?>"
                        readonly
                    >
                </div>
                ...
                <div class="form-group required">
                    ...
                    <input 
                        ...
                        id="trangthai" 
                        name="trangthai" 
                        value="<?= htmlspecialchars($hopdong['trangthai'] ?? '') ?>"
                        readonly
                    >
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group required">
                    ...
                    <input 
                        ...
                        id="batdau" 
                        name="batdau" 
                        value="<?= htmlspecialchars($hopdong['batdau'] ?? '') ?>"
                        readonly
                    >
                </div>
                ...
                <div class="form-group required">
                    ...
                    <input 
                        ...
                        id="hethan" 
                        name="hethan" 
                        value="<?= htmlspecialchars($hopdong['hethan'] ?? '') ?>"
                        readonly
                    >
                </div>
            </div>
