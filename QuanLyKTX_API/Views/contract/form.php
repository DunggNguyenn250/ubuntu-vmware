        ...
        <form method="POST" action="<?= htmlspecialchars($actionUrl) ?>">
            ...
            <div class="form-row">
                <div class="form-group required">
                    ...
                    <input 
                        ...
                        value="<?= htmlspecialchars($contract['mahopdong'] ?? $nextMaHopDong ?? '') ?>"
                ...
                <div class="form-group required">
                    ...
                    <select id="masv" name="masv" class="select2-search <?= $isEdit ? 'readonly-field' : '' ?>" required>
                    ...
                    <?php if($isEdit): ?>
                        <input type="hidden" name="masv" value="<?= htmlspecialchars($contract['masv'] ?? '') ?>">
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group required">
                    ...
                    <select id="maphong" name="maphong" class="select2-search <?= $isEdit ? 'readonly-field' : '' ?>" required>
                    ...
                    <?php if($isEdit): ?>
                        <input type="hidden" name="maphong" value="<?= htmlspecialchars($contract['maphong'] ?? '') ?>">
                    <?php endif; ?>
                </div>

                <div class="form-group required">
                    <label for="trangthai">Trạng Thái</label>
                    <select id="trangthai" name="trangthai" <?= $isEdit ? 'class="readonly-field"' : 'required' ?>>
            ...
            <div class="form-row">
                <div class="form-group required">
                    ...
                    <input 
                        ...
                        id="batdau" 
                        name="batdau" 
                        class="<?= $isEdit ? 'readonly-field' : '' ?>"
                        value="<?= htmlspecialchars($contract['batdau'] ?? '') ?>"
                ...
                <div class="form-group required">
                    ...
                    <input 
                        ...
                        id="hethan" 
                        name="hethan" 
                        value="<?= htmlspecialchars($contract['hethan'] ?? '') ?>"
                        required
                    >
                </div>
            </div>
